...
An Overlay allows multiple config values to be merged in a particular order
...
A multiplexer uses the result of a supplied code block to determine the value
for a certain config key
